...
YZSYNTH_DUMMY_CLASS(NSData_YZAdd)


@implementation NSData (YZAdd)
...
- (NSData *)yz_aes256EncryptWithKey:(NSData *)key iv:(NSData *)iv {
...
- (NSData *)yz_aes256DecryptWithkey:(NSData *)key iv:(NSData *)iv {
    if (key.length != 16 && key.length != 24 && key.length != 32) {
        return nil;
    }
    if (iv.length != 16 && iv.length != 0) {
