 ...
 */
+ (nullable NSString *)yz_stringWithBase64EncodedString:(NSString *)base64EncodedString;

/**
 URL encode a string in utf-8.
 @return the encoded string.
 */
- (NSString *)yz_stringByURLEncode;

/**
 URL decode a string in utf-8.
 @return the decoded string.
 */
- (NSString *)yz_stringByURLDecode;

/**
 Escape common HTML to Entity.
 Example: "a>b" will be escape to "a&gt;b".
 */
- (NSString *)yz_stringByEscapingHTML;
 ...
 */
- (CGSize)yz_sizeForFont:(UIFont *)font size:(CGSize)size mode:(NSLineBreakMode)lineBreakMode;
 ...
 */
- (CGFloat)yz_widthForFont:(UIFont *)font;
 ...
 */
- (CGFloat)yz_heightForFont:(UIFont *)font width:(CGFloat)width;
 ...
 */
- (BOOL)yz_matchesRegex:(NSString *)regex options:(NSRegularExpressionOptions)options;
 ...
 */
- (void)yz_enumerateRegexMatches:(NSString *)regex
 ...
 */
- (NSString *)yz_stringByReplacingRegex:(NSString *)regex
                             options:(NSRegularExpressionOptions)options
 ...
 */
+ (nullable NSString *)yz_stringWithUTF32Char:(UTF32Char)char32;
 ...
 */
+ (nullable NSString *)yz_stringWithUTF32Chars:(const UTF32Char *)char32 length:(NSUInteger)length;
 ...
 */
- (void)yz_enumerateUTF32CharInRange:(NSRange)range usingBlock:(void (^)(UTF32Char char32, NSRange range, BOOL *stop))block;

/**
 Trim blank characters (space and newline) in head and tail.
 @return the trimmed string.
 */
- (NSString *)yz_stringByTrim;
 ...
 */
- (NSString *)yz_stringByAppendingNameScale:(CGFloat)scale;
...
/**
 ...
 @return String by add scale modifier, or just return if it's not end with file name.
 */
- (NSString *)yz_stringByAppendingPathScale:(CGFloat)scale;
 ...
 */
- (BOOL)yz_containsString:(NSString *)string;
 ...
 */
- (BOOL)yz_containsCharacterSet:(NSCharacterSet *)set;

/**
 Try to parse this string and returns an `NSNumber`.
 @return Returns an `NSNumber` if parse succeed, or nil if an error occurs.
 */
- (nullable NSNumber *)yz_numberValue;

/**
 Returns an NSData using UTF-8 encoding.
 */
- (nullable NSData *)yz_dataValue;

/**
 Returns NSMakeRange(0, self.length).
 */
- (NSRange)yz_rangeOfAll;
 ...
 */
- (nullable id)yz_jsonValueDecoded;
 ...
 */
+ (nullable NSString *)yz_stringNamed:(NSString *)name;
