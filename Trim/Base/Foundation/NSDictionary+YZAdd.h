 ...
 */
+ (nullable NSDictionary *)yz_dictionaryWithPlistData:(NSData *)plist;
 ...
 */
+ (nullable NSDictionary *)yz_dictionaryWithPlistString:(NSString *)plist;
 ...
 */
+ (nullable NSDictionary *)yz_dictionaryWithXML:(id)xmlDataOrString;
 ...
 */
@interface NSMutableDictionary (YZAdd)
...
/**
 ...
 @discussion Apple has implemented this method, but did not make it public.
 */
+ (nullable NSMutableDictionary *)yz_dictionaryWithPlistData:(NSData *)plist;
...
/**
 ...
 @return A new dictionary created from the plist string, or nil if an error occurs.
 */
+ (nullable NSMutableDictionary *)yz_dictionaryWithPlistString:(NSString *)plist;
 ...
 */
- (nullable id)yz_popObjectForKey:(id)aKey;
