 ...
 */
- (nullable NSData *)yz_aes256EncryptWithKey:(NSData *)key iv:(nullable NSData *)iv;
 ...
 */
- (nullable NSData *)yz_aes256DecryptWithkey:(NSData *)key iv:(nullable NSData *)iv;
