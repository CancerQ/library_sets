 ...
 */
- (nullable NSDate *)yz_dateByAddingYears:(NSInteger)years;
 ...
 */
- (nullable NSDate *)yz_dateByAddingMonths:(NSInteger)months;
 ...
 */
- (nullable NSDate *)yz_dateByAddingWeeks:(NSInteger)weeks;
 ...
 */
- (nullable NSDate *)yz_dateByAddingDays:(NSInteger)days;
 ...
 */
- (nullable NSDate *)yz_dateByAddingHours:(NSInteger)hours;
 ...
 */
- (nullable NSDate *)yz_dateByAddingMinutes:(NSInteger)minutes;
 ...
 */
- (nullable NSDate *)yz_dateByAddingSeconds:(NSInteger)seconds;
 ...
 */
- (nullable NSString *)yz_stringWithFormat:(NSString *)format;
 ...
 */
- (nullable NSString *)yz_stringWithISOFormat;
 ...
 */
+ (nullable NSDate *)yz_dateWithString:(NSString *)dateString format:(NSString *)format;
...
/**
 ...
 If can not parse the string, returns nil.
 */
+ (nullable NSDate *)yz_dateWithString:(NSString *)dateString
...
/**
 ...
 If can not parse the string, returns nil.
 */
+ (nullable NSDate *)yz_dateWithISOFormatString:(NSString *)dateString;
