 ...
 */
@interface NSBundle (YZAdd)

/**
 An array of NSNumber objects, shows the best order for path scale search.
 e.g. iPhone3GS:@[@1,@2,@3] iPhone5:@[@2,@3,@1]  iPhone6 Plus:@[@3,@2,@1]
 */
+ (NSArray<NSNumber *> *)yz_preferredScales;
 ...
 */
+ (nullable NSString *)yz_pathForScaledResource:(NSString *)name
 ...
 */
- (nullable NSString *)yz_pathForScaledResource:(NSString *)name ofType:(nullable NSString *)ext;
