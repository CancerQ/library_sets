 ...
 */
typedef NS_OPTIONS(NSUInteger, YZNetworkTrafficType) {
    YZNetworkTrafficTypeWWANSent     = 1 << 0,
    YZNetworkTrafficTypeWWANReceived = 1 << 1,
    YZNetworkTrafficTypeWIFISent     = 1 << 2,
    YZNetworkTrafficTypeWIFIReceived = 1 << 3,
    YZNetworkTrafficTypeAWDLSent     = 1 << 4,
    YZNetworkTrafficTypeAWDLReceived = 1 << 5,
    
    YZNetworkTrafficTypeWWAN = YZNetworkTrafficTypeWWANSent | YZNetworkTrafficTypeWWANReceived,
    YZNetworkTrafficTypeWIFI = YZNetworkTrafficTypeWIFISent | YZNetworkTrafficTypeWIFIReceived,
    YZNetworkTrafficTypeAWDL = YZNetworkTrafficTypeAWDLSent | YZNetworkTrafficTypeAWDLReceived,
    
    YZNetworkTrafficTypeALL = YZNetworkTrafficTypeWWAN |
                              YZNetworkTrafficTypeWIFI |
                              YZNetworkTrafficTypeAWDL,
};
...
/**
 ...
 Usage:
     ...
     uint64_t bytes = [[UIDevice currentDevice] getNetworkTrafficBytes:YZNetworkTrafficTypeALL];
