...
YZSYNTH_DUMMY_CLASS(UIColor_YZAdd)


#define CLAMP_COLOR_VALUE(v) (v) = (v) < 0 ? 0 : (v) > 1 ? 1 : (v)

void YZ_RGB2HSL(CGFloat r, CGFloat g, CGFloat b,
...
void YZ_HSL2RGB(CGFloat h, CGFloat s, CGFloat l,
...
void YZ_RGB2HSB(CGFloat r, CGFloat g, CGFloat b,
...
void YZ_HSB2RGB(CGFloat h, CGFloat s, CGFloat v,
                CGFloat *r, CGFloat *g, CGFloat *b) {
    CLAMP_COLOR_VALUE(h);
    CLAMP_COLOR_VALUE(s);
    CLAMP_COLOR_VALUE(v);
...
void YZ_RGB2CMYK(CGFloat r, CGFloat g, CGFloat b,
...
void YZ_CMYK2RGB(CGFloat c, CGFloat m, CGFloat y, CGFloat k,
                 CGFloat *r, CGFloat *g, CGFloat *b) {
    CLAMP_COLOR_VALUE(c);
    CLAMP_COLOR_VALUE(m);
    CLAMP_COLOR_VALUE(y);
...
void YZ_HSB2HSL(CGFloat h, CGFloat s, CGFloat b,
...
void YZ_HSL2HSB(CGFloat h, CGFloat s, CGFloat l,
...
+ (UIColor *)colorWithHue:(CGFloat)hue
               saturation:(CGFloat)saturation
                lightness:(CGFloat)lightness
                    alpha:(CGFloat)alpha {
    CGFloat r, g, b;
    YZ_HSL2RGB(hue, saturation, lightness, &r, &g, &b);
...
+ (UIColor *)colorWithCyan:(CGFloat)cyan
                   magenta:(CGFloat)magenta
                    yellow:(CGFloat)yellow
                     ...
                     alpha:(CGFloat)alpha {
    CGFloat r, g, b;
    YZ_CMYK2RGB(cyan, magenta, yellow, black, &r, &g, &b);
    return [UIColor colorWithRed:r green:g blue:b alpha:alpha];
}
...
static BOOL hexStrToRGBA(NSString *str,
    ...
    str = [[str yz_stringByTrim] uppercaseString];
    if ([str hasPrefix:@"#"]) {
...
- (BOOL)yz_getHue:(CGFloat *)hue
    ...
    YZ_RGB2HSL(r, g, b, hue, saturation, lightness);
    *alpha = a;
    return YES;
}

- (BOOL)yz_getCyan:(CGFloat *)cyan
           magenta:(CGFloat *)magenta
            yellow:(CGFloat *)yellow
             black:(CGFloat *)black
             alpha:(CGFloat *)alpha {
    ...
    YZ_RGB2CMYK(r, g, b, cyan, magenta, yellow, black);
    *alpha = a;
    return YES;
}
