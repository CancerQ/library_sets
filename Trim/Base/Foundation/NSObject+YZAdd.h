 ...
 */
- (nullable id)yz_performSelectorWithArgs:(SEL)sel, ...;
 ...
 */
- (nullable id)yz_performSelectorWithArgsOnMainThread:(SEL)sel waitUntilDone:(BOOL)wait, ...;
 ...
 */
- (nullable id)yz_performSelectorWithArgs:(SEL)sel onThread:(NSThread *)thread waitUntilDone:(BOOL)wait, ...;
 ...
 */
- (void)yz_setAssociateValue:(nullable id)value withKey:(void *)key;
...
/**
 ...
 @param key    The pointer to get value from `self`.
 */
- (void)yz_setAssociateWeakValue:(nullable id)value withKey:(void *)key;
...
/**
 ...
 @param key The pointer to get value from `self`.
 */
- (nullable id)yz_getAssociatedValueForKey:(void *)key;
 ...
 */
- (nullable id)yz_deepCopyWithArchiver:(Class)archiver unarchiver:(Class)unarchiver;
